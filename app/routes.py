...
def index():
    ...
    posts = [
        ...
        {
        'text': ''' Первым делом автор поста должен заинтересовать свою аудиторию. 
             Помимо качественного снимка (о нем мы расскажем позже),первым делом аудитория 
             обращает внимание на тематику поста. ''',
        'date': '2023-09-01'
        },
